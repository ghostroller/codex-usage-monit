...
- **项目用量汇总** — 按本周期、近 7 天或近 30 天排行项目；展开具有明确类型标识的项目/session/subagent 树，并通过项目排行柱状图和可从 1 天细化到 1 小时的项目着色堆叠面积图，比较 token、估算 credit 费率或 API 等价用量。
